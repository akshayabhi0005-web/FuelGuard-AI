...
import { Fuel, Flame, ArrowRight, UserCheck } from 'lucide-react';
        ...
        <div style={{ maxWidth: '800px', width: '100%', textAlign: 'center' }}>
          ...
          >
            ...
            <p style={{ color: 'var(--text-secondary)', fontSize: '1rem', maxWidth: '500px', margin: '0 auto' }}>
              Select the operations module you want to authenticate into.
            </p>
          </motion.div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '2rem' }} className="grid-mobile">
            ...
            >
              ...
              <h2 style={{ fontSize: '1.35rem', fontWeight: 700 }}>Fuel Services</h2>
              <p style={{ fontSize: '0.85rem', color: 'var(--text-secondary)' }}>Sign in to manage smart vehicle quotas, generate dynamic scan tokens, or lookup transaction receipts.</p>
              <button className="btn btn-primary" style={{ width: '100%', background: 'linear-gradient(135deg, #2563eb 0%, #06b6d4 100%)' }}>
                Go to Fuel Login <ArrowRight size={14} />
              </button>
            </motion.div>
            ...
            >
              ...
              <h2 style={{ fontSize: '1.35rem', fontWeight: 700 }}>LPG Services</h2>
              <p style={{ fontSize: '0.85rem', color: 'var(--text-secondary)' }}>Sign in to schedule domestic cylinder refills, check distributor deliveries, or update verification cards.</p>
              <button className="btn btn-primary" style={{ width: '100%', background: 'linear-gradient(135deg, #ea580c 0%, #8b5cf6 100%)' }}>
                Go to LPG Login <ArrowRight size={14} />
              </button>
            </motion.div>
          </div>
          ...
          <div style={{ marginTop: '2rem' }}>
            <span style={{ fontSize: '0.8rem', color: 'var(--text-secondary)' }}>
              Looking for Operator Command Portals? Go to <Link to="/fuel/login" style={{ color: '#06b6d4', textDecoration: 'underline' }}>Government Admin Login</Link>
            </span>
          </div>
